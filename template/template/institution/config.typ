#import "../config-utils.typ": (
  default-value, get-dict-without-default, validate-enable,
  validate-generator, validate-position-order,
)
...
#let configure-dhbw-ka-ai-acknowledgement(
  ...
  return (
    front-back-matter: (
      ai-acknowledgement: get-dict-without-default((
        entries: entries,
        position: position,
        order: order,
...
#let configure-dhbw-ma-ai-declaration-form(
  ...
  exam-type: default-value,
  /// Submission date shown on the AI declaration form. -> str | none
  module-submission-date: default-value,
  ...
  return (
    front-back-matter: (
      ai-declaration-form: get-dict-without-default((
