### General terms
at-the-institution = an der { $institution } { $city }
weeks = { $count } {
    $count ->
        [one] Woche
       *[other] Wochen
...
place-of-signature = Ort
date-of-signature = Datum
...
# appendix
appendix = Anhang
list-of-appendices = Anhangsverzeichnis
...
statutory-declaration-note-dhbw-old-printed = { $author-count ->
    [one] Ich versichere zudem, dass die eingereichte elektronische Fassung mit der gedruckten Fassung übereinstimmt.
   *[other] Wir versichern zudem, dass die eingereichte elektronische Fassung mit der gedruckten Fassung übereinstimmt.
}
...
ai-dec-scientific-responsibility = Mir ist bewusst, dass ich als Author/in der Arbeit die Verantwortung für die in ihr gemachten Angaben und Aussagen trage.
...
ai-dec-title-products = #underline[Produktname] (n) eingesetzter Hilfsmittel:
ai-dec-title-used-functions = #underline[Genutzter Funktionsumfang] im Hinblick auf:
...
ai-dec-generation-correcture = Textgenerierung, Korrektur
notice = Hinweis
...
sign-student = Unterschrift der/des Studierenden
