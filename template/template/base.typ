...
#let project(
  ...
  /// Adds a confidentiality clause and prints a confidential-stamp on the title page.
  /// Adapters enabling this parameter must create a label `<__confidentiality-clause>` somewhere in the document.
  __confidentiality-clause: false,
